...
<body>
    ...
    <div class="main_wrapper">
        ...
        <div class="content_wrapper">
            	...
            	<div id="headline">
                	<div id="headline_content">
						...
						if(isset($_SESSION['customer_email'])){
							...
							echo "<b>Welcome:" . "</b> &nbsp;" . "<b style='color:purple;'>" . $_SESSION['customer_email'] . "</b>";
           ...
           <h2 style="background:#FFF; color:#000; padding:20px; text-align:center; border-top:1px solid #000;">Account Details </h2>
