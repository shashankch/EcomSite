    ...
    <div class="main_wrapper">
        ...
        <div class="content_wrapper">
                	...
                	<div id="headline_content">
                        ...
                        if(!isset($_SESSION['customer_email']))
						{
							echo "<b>Welcome Guest!</b> <b style='color:orange'>Shopping Cart</b>";
								...
								echo "<b>Welcome:" . "<span style='color:skyblue'>" . $_SESSION['customer_email'] . "</span>" . "</b>" . "<b style='color:black'>Your Shopping Cart </b>";
								}
						?> 
                    	<span> - Total Items: <?php items(); ?> - Total Price: <?php total_price(); ?> - <a href="index.php" style="color:purple;">Back to Shopping</a>
           ...
           <form action="cart.php" method="post" enctype="multipart/form-data">
            	...
            	<table width="740" align="center" bgcolor="#F1F3F6">
